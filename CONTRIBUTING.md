...
If you are going to make a pull request, please do the following:

* If this pull request is about an unsolved issue, LIST THE ISSUE.
* Explain what you did for the and how this will solve the issue (if any).
* Tell me how you want to be named in the credits, or simply tell me to not be included in the credits.
